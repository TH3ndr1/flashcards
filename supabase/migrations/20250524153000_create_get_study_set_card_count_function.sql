-- Migration: Create get_study_set_card_count function
-- Version: 1
-- Description: This migration creates the public.get_study_set_card_count(uuid, jsonb) function.
--              This function calculates the number of cards matching a given query_criteria JSON,
--              similar to resolve_study_query, but returns a count instead of card IDs.
...
COMMENT ON FUNCTION public.get_study_set_card_count(uuid, jsonb) IS
'Calculates the number of cards matching a given query_criteria JSON. v1. (Updated to use srsFilter)'; 