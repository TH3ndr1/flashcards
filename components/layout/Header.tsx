...
const HeaderInternal = ({ onToggleMobileSidebar }: HeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 flex h-16 items-center justify-between border-b bg-background dark:bg-slate-800 dark:border-slate-700 px-4 md:px-6">
