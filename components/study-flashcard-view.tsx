...
export function StudyFlashcardView({
  ...
  // useEffect for keypress - TTS keys removed since auto-TTS handles it
  useEffect(() => {
  ...
  }, [isFlipped, isTransitioning, onAnswer, onFlip, card]); 
      ...
      >
        <div className="flip-card-inner relative w-full h-full">
          ...
          <div className="flip-card-front absolute w-full h-full">
            ...
            <Card className={cn("w-full h-full flex flex-col flashcard-border shadow-lg hover:shadow-xl transition-shadow duration-300", fontClass)} style={cardDarkBgStyle}>
                ...
                <TooltipProvider>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="sm" variant="outline" className="flex-1 justify-center text-xs border-red-500 text-red-700 hover:bg-red-500/10 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 active:scale-95 transition-all duration-150 sm:w-auto sm:justify-start sm:text-sm" onClick={(e) => { e.stopPropagation(); onAnswer(1); }} disabled={isTransitioning} aria-label="Again - Complete reset (Press 1)">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="sm" variant="outline" className="flex-1 justify-center text-xs border-amber-500 text-amber-700 hover:bg-amber-500/10 hover:text-amber-800 dark:text-amber-400 dark:hover:text-amber-300 active:scale-95 transition-all duration-150 sm:w-auto sm:justify-start sm:text-sm" onClick={(e) => { e.stopPropagation(); onAnswer(2); }} disabled={isTransitioning} aria-label="Hard - Remember with significant effort (Press 2)">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="sm" variant="outline" className="flex-1 justify-center text-xs border-green-500 text-green-700 hover:bg-green-500/10 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 active:scale-95 transition-all duration-150 sm:w-auto sm:justify-start sm:text-sm" onClick={(e) => { e.stopPropagation(); onAnswer(3); }} disabled={isTransitioning} aria-label="Fair - Remember with some effort (Press 3)">
                        <ThumbsUp className="h-4 w-4 sm:mr-1" />
